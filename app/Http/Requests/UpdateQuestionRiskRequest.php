...
class UpdateQuestionRiskRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            'due_date' => 'required',
            'priority' => 'required',
            'status' => 'required|in:draft,in_progress,completed,resolved,rejected',
    ...
    public function messages()
    {
        return [
            ...
            'assignees.required' => 'Assignee is required',
